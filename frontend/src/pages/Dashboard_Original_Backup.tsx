...
const Dashboard: React.FC = () => {
  ...
  // Fetch comparison results when comparison tab is active
  useEffect(() => {
  ...
  const handleTabChange = (tab: "analysis" | "comparison") => {
    ...
    const newUrl =
      tab === "analysis"
        ...
        : `${window.location.pathname}?tab=comparison`;
    window.history.pushState(null, "", newUrl);

    // Exit comparison mode when switching tabs
    if (comparisonMode) {
  ...
  const handleComparisonClick = (comparison: ComparisonResult) => {
    ...
    setExpandedComparison(isExpanded ? null : comparison.id);
  };

  // const handleViewFullComparison = (comparison: ComparisonResult) => {
  ...
  //     setComparisonResults((prev) => prev.filter((c) => c.id !== comparisonId));
  //     setComparisonError(null);
  //   } catch (err) {
  ...
  const transformAnalysisForDisplay = (analysis: UserAnalysis) => {
    ...
    // Transform BCG matrix format from camelCase to snake_case for export compatibility
    ...
    Object.entries(bcgMatrix).forEach(([key, value]) => {
      if (
        value &&
        typeof value === "object" &&
        ("marketShare" in value || "market_share" in value) &&
        ("growthRate" in value || "growth_rate" in value)
      ) {
        // Handle both camelCase (from database) and snake_case formats
        transformedBcg[key] = {
          market_share:
            (value as any).marketShare || (value as any).market_share,
          growth_rate: (value as any).growthRate || (value as any).growth_rate,
        };
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Comparison Controls Section - Only show in analysis tab */}
        {activeTab === "analysis" && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
            <div className="px-6 py-4 border-b border-gray-200">
        ...
        {/* Analysis History - Only show in analysis tab */}
        {activeTab === "analysis" && (
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="bg-white/70 backdrop-blur-sm rounded-xl p-2 border border-teal-100/50 shadow-sm">
                                    ...
                                    <p className="text-xs text-teal-600 mt-1">
                                      {
                                        analysisData.pestelLists.political
                                          .length
                                      }{" "}
                                      items
                                    </p>
                              ...
                              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                                {analysisData.swotImage && (
                                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-3 border border-gray-200/50 shadow-lg">
                                    <img
                                      src={
                                        analysisData.swotImage.startsWith(
                                          "data:"
                                        )
                                          ? analysisData.swotImage
                                ...
                                {analysisData.bcgImage && (
                                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-3 border border-gray-200/50 shadow-lg">
                                    <img
                                      src={
                                        analysisData.bcgImage.startsWith(
                                          "data:"
                                        )
                                          ? analysisData.bcgImage
        ...
        {/* Comparison Results - Only show in comparison tab */}
        {activeTab === "comparison" && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
              ...
              <p className="text-sm text-gray-600 mt-1">
                View and manage your saved comparison reports
              </p>
            </div>
            ...
            <div className="divide-y divide-gray-200">
              {isLoadingComparisons ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    Go to the Analysis tab to create your first comparison!
                  </p>
                </div>
              ) : (
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              // TODO: Add export functionality for comparisons
                            }}
                            className="p-2 text-gray-400 hover:text-green-600 transition-colors duration-200"
                    ...
                    {expandedComparison === comparison.id && (
                      <div className="mt-6 p-6 bg-gradient-to-br from-white/90 via-gray-50/50 to-purple-50/30 rounded-2xl border border-gray-200/50 shadow-lg backdrop-blur-sm">
                        <div className="space-y-6">
                          {/* Summary */}
                          <div className="bg-gradient-to-br from-purple-50/80 to-indigo-100/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/50 shadow-lg">
                            <div className="flex items-center mb-4">
                              <div className="p-2 bg-purple-500/90 rounded-lg shadow-sm">
                            ...
                            <div className="space-y-3">
                              <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-purple-100/50 shadow-sm">
                                <h6 className="font-medium text-purple-800 text-sm mb-2">
                                  Companies Analyzed
                                </h6>
                                <div className="flex flex-wrap gap-2">
                                  {(
                                    comparison.companyNames ||
                                    comparison.analyses?.map(
                                      (a) => a.companyName
                                    )
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                            <div className="text-sm text-gray-500">
                              Created on {formatDate(comparison.comparisonDate)}
                            </div>
                            <div className="flex items-center space-x-3">
                              <button
                                onClick={async () => {
                                  try {
                                    console.log(
                                      "Fetching full comparison data for ID:",
                                      comparison.id
                                    );
                                    const fullComparisonData =
                                      await ApiService.getSavedComparison(
                                        comparison.id
                                      );
                                    console.log(
                                    ...
                                    console.error(
                                      "Failed to fetch full comparison data:",
                                      error
                                    );
                      ...
                      <tbody>
                        ...
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          {comparisonResult.metrics.map(
                            (metric: any, index: number) => {
                              ...
                              const isHighest =
                                metric.marketShare === Math.max(...values);
                              return (
                                <td
                                  key={index}
                          ...
                          <td className="py-3 px-4 text-center text-blue-600 font-medium">
                            {comparisonResult.benchmarks?.avgMarketShare?.toFixed(
                              2
                            )}
                            %
                          </td>
                        ...
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          {comparisonResult.metrics.map(
                            (metric: any, index: number) => {
                              ...
                              const isHighest =
                                metric.growthRate === Math.max(...values);
                              return (
                                <td
                                  key={index}
                                  className={`py-3 px-4 text-center ${
                          ...
                          <td className="py-3 px-4 text-center text-blue-600 font-medium">
                            {comparisonResult.benchmarks?.avgGrowthRate?.toFixed(
                              2
                            )}
                            %
                          </td>
                        ...
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          {comparisonResult.metrics.map(
                            (metric: any, index: number) => {
                              ...
                              const isLowest =
                                metric.riskRating === Math.min(...values);
                              return (
                                <td
                                  key={index}
                                  className={`py-3 px-4 text-center ${
                          ...
                          <td className="py-3 px-4 text-center text-blue-600 font-medium">
                            {comparisonResult.benchmarks?.avgRiskRating?.toFixed(
                              1
                            )}
                            /10
                          </td>
                        ...
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          {comparisonResult.metrics.map(
                            (metric: any, index: number) => {
                              const values = comparisonResult.metrics.map(
                                (m: any) => m.sentimentScore
                              );
                              const isHighest =
                                metric.sentimentScore === Math.max(...values);
                              return (
                                <td
                                  key={index}
                                  className={`py-3 px-4 text-center ${
                                ...
                                >
                                  {metric.sentimentScore?.toFixed(1)}/100
                                </td>
                              );
                            }
                          )}
                          <td className="py-3 px-4 text-center text-blue-600 font-medium">
                            {comparisonResult.benchmarks?.avgSentimentScore?.toFixed(
                              1
                            )}
                            /100
                          </td>
          ...
          <div className="bg-white rounded-2xl max-w-6xl max-h-[90vh] overflow-y-auto w-full">
            ...
            <div className="p-6">
              <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(
                          ...
                          selectedComparison.analyses?.map((a) => a.companyName)
                        )?.map((company, index) => (
                          <span
                            key={index}
                  ...
                  {selectedComparison.radarChart && (
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                      ...
                      <div className="flex justify-center">
                        <img
                          src={selectedComparison.radarChart}
                          alt="Radar Chart"
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {selectedComparison.barGraph && (
                      <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <img
                          src={selectedComparison.barGraph}
                          alt="Bar Chart"
                    ...
                    {selectedComparison.scatterPlot && (
                      <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <img
                          src={selectedComparison.scatterPlot}
                          alt="Scatter Plot"
                          className="w-full h-auto rounded-lg shadow-sm"
                        />
                      </div>
                ...
                {/* Individual Company Analyses Summary */}
                {selectedComparison.analyses &&
                  selectedComparison.analyses.length > 0 && (
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">
                        Individual Company Analysis Summary
                      </h3>
                      <div className="space-y-6">
                        {selectedComparison.analyses.map((analysis, index) => (
                          ...
                          >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                  <div className="bg-green-50 rounded p-2">
                                    ...
                                    <span className="text-green-600 ml-1">
                                      {analysis.swotLists.strengths?.length ||
                                        0}{" "}
                                      items
                                    </span>
                                  </div>
                                  <div className="bg-red-50 rounded p-2">
                                    ...
                                    <span className="text-red-600 ml-1">
                                      {analysis.swotLists.weaknesses?.length ||
                                        0}{" "}
                                      items
                                    </span>
                                  </div>
                              ...
                              <div className="mb-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                                  <span className="bg-gray-100 rounded px-2 py-1">
                                    Political:{" "}
                                    {analysis.pestelLists.political?.length ||
                                      0}
                                  </span>
                                  <span className="bg-gray-100 rounded px-2 py-1">
                                    Economic:{" "}
                            ...
                            {/* Strategy Recommendations Preview */}
                              ...
                              analysis.summaries.length > 0 && (
                                <div className="mt-3 bg-gray-50 rounded-lg p-3">
                                  ...
                                  <p
                                    ...
                                    dangerouslySetInnerHTML={{
                                      __html: analysis.summaries[0],
                                    }}
                                  ></p>
                                  {analysis.summaries.length > 1 && (
                                    <p className="text-xs text-gray-500 mt-2">
                                      + {analysis.summaries.length - 1} more
                                      summaries
                                    </p>
                                  )}
                                </div>
