...
public class SentimentTrendService {
     ...
     * @return Map with time_series, trends, significant_events, and source-specific
     *         analysis
     */
    ...
    public Map<String, Object> analyzeTrends(String companyName, int days, List<String> sources) {
        ...
        List<SentimentData> data = repository.findByCompanyNameAndTimestampBetween(companyName, start,
                LocalDateTime.now());
        ...
        response.put("analysis_timestamp", timeUtil.nowAsString());
